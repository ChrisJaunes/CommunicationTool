...
public class GroupConfig {
    ...
    static final public String STR_SEND_TIME = "sendTime";
    static final public String STR_CONTENT_TYPE = "contentType";
    ...
    public static final String STATUS_ADD_SUCCESSFUL = "add successful";
    public static final String URL_GROUP_ADD = "group/add";
    public static final String URL_GROUP_QUERY = "group/query";
